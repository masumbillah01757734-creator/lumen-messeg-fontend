...
export default function ChatWindow({ chatId, onChatMutated, onBack }) {
  ...
  return (
    <div className="flex-1 flex flex-col h-[80vh] bg-base">
      {/* Header */}
      <div className="fixed flex items-center gap-3 px-3 md:px-4 py-2.5 border-b border-border bg-surface/95 backdrop-blur supports-[backdrop-filter]:bg-surface/80">
        <button
